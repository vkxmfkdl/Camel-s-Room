...
<html lang="en">
<head>
    <title>Code coverage report for cliopts.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> cliopts.ts
    </h1>
    <div class='clearfix'>
...
export function getCLIOptions(prog: program.ICommand): ICLIOpts
{
  let opts: ICLIOpts = {
    ...
    strict    <span class="branch-0 cbranch-no" title="branch not covered" >     : typeof p</span>rog['strict'] === 'boolean'
                       ? prog['strict']
                       : false
  };
&nbsp;
